...
return new class extends Migration
{
    ...
    {
        // La aplicación todavía usa las configuraciones históricas de SUNAT,
        // endpoints, archivos, resúmenes y seguridad. Conservarlas evita
        // eliminar credenciales o comportamiento configurado por la empresa.
        // Esta migración solo completa valores base que aún no existan.
        ...
        foreach ($companies as $company) {
            ...
            DB::table('company_configurations')->insertOrIgnore([
    ...
    {
        // No se eliminan configuraciones durante rollback porque pueden
        // contener credenciales y preferencias creadas por los usuarios.
    }
};
